...
def main():
    inicio = time.time()
    tamaño, matriz, resultadoFila, resultadoColumna, numeroPorDefecto = leerFichero('test00.txt')
    contadorDeSoluciones = BackTracking(numeroPorDefecto, tamaño, matriz, numeroPorDefecto, resultadoFila, resultadoColumna, 0)
    fin = time.time()
    tiempoTotal = fin-inicio
    print("El tiempo que se tarda en hallar la primera solución al cuadrado es: ",round(tiempoTotal,4)," segundos y el número de soluciones"
    " son: ", contadorDeSoluciones)
...
def BackTracking(numeroGenerado, tamaño, matriz, numeroPorDefecto, resultadoFila, resultadoColumna, contadorDeSoluciones):
    ...
    while(numeroGenerado[0] != '10' and SolucionEncontrada == False):
        ...
        SolucionEncontrada = BackTracking(numeroGenerado, tamaño, matriz, numeroPorDefecto, resultadoFila, resultadoColumna, contadorDeSoluciones)
    if( SolucionEncontrada == False):
        return contadorDeSoluciones
