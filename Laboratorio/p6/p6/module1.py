...
def main():
    inicio = time.time()
    tamaño, matriz, resultadoFila, resultadoColumna, numeroPorDefecto, bucle, listaPosiciones = leerFichero('test01.txt')
...
def GenerarNumero(numeroPorDefecto, numero, bucle, listaPosiciones):
    ...
    for i in range(bucle):
        if(numero > 0):
            ...
            nuevoNumero.insert(0, str(digito))  # Insertamos el dígito al principio de la lista
            numero = numero // 10
        else:
